    ...
    summonerShowInfo(){
            ...
            <div class="rank-box">
                ...
                <div class="rank-info">
                    <div class="rank-score">
                        <div>
                            <h2 style="font-size : 20px">${leagueData[0].tier}</h2>
                        </div>
                        <div>
                            <h4 style="font-size : 15px">${leagueData[0].leaguePoints} LP</h4>
                        </div>
                        <div>
                            <h2 style="font-size : 20px">${leagueData[0].wins}승 ${leagueData[0].losses}패</h2>
                        </div>
                        <div>
        ...
        matchInfo.forEach((data, index) => {
            ...
            participantsInfo.forEach((data, index3) => {
                ...
                if(participantsInfo[index3].win == "true"){
                ...
                if(participantsInfo[index3].win == "false"){
            ...
            <div class="match-box win-color" id="match-box">
                ...
                <div class="match-info-thi">
                    <div class="text-kidecs">
                        <span>${participantsInfo[participantObj.parIndex].kills} / ${participantsInfo[participantObj.parIndex].deaths} / ${participantsInfo[participantObj.parIndex].assists} (${participantsInfo[participantObj.parIndex].deaths == 0 ? (participantsInfo[participantObj.parIndex].kills + participantsInfo[participantObj.parIndex].assists):((participantsInfo[participantObj.parIndex].kills + participantsInfo[participantObj.parIndex].assists)/participantsInfo[participantObj.parIndex].deaths).toFixed(2)})</span>
                    </div>
                    <div class="text-kidecs">
