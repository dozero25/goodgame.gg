...
public class AdminUserApi {
    ...
    public ResponseEntity<CMRespDto<?>> AdminUserSearch(AdminUserSearchDTO AdminUserSearchDTO) {

        return ResponseEntity
                .ok()
                .body(new CMRespDto<>(HttpStatus.OK.value(), "Successfully",    adminUserService.AdminUserSearch(AdminUserSearchDTO)));
    }
